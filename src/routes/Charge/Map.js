  ...
  render() {
    ...
    return (
      <PageHeaderLayout
        ...
        content={
          <Fragment>
            <span>{station.name === '升升公寓' ? '武汉升升学府物业管理有限公司' : '武汉理工大学水电管理中心'}</span><br />
            <span>联系电话：{station.telephone ? <a href={'tel:027-' + station.telephone}>{station.telephone}</a> : '暂无'}</span>
          </Fragment>
          }
      >
        <div style={{ width: '100%', height: '500px', boxShadow: '0 1px 2px rgba(0,0,0,.3)', marginBottom: '5px' }}>
