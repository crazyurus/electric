...
<script>
  export default {
    ...
    mounted () {
      this.$indicator.show();
      this.$http.get('/electric/notice/content', {
    ...
    methods: {
      share() {
        ...
        else location.assign('mqqapi://share/to_fri?src_type=web&version=1&file_type=news&share_id=1109559705&title=' + btoa(this.article.title) + '&thirdAppDisplayName=5o6M5LiK55CG5bel5aSn&url=' + btoa(location.href) + '&description=' + btoa('来自掌上理工大电费查询'));
      }
    }
  }
</script>
