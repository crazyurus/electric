  ...
  <f7-page name="feedback">
    ...
    <f7-list media-list>
      ...
      <f7-list-item
        ...
        text="掌理粉丝聚集地"
        link-external
        link="mqqapi://card/show_pslcard?src_type=internal&version=1&uin=420082599&card_type=group&source=qrcode"
      ></f7-list-item>
      <f7-list-item
        title="电费充值故障群"
        text="在缴费平台充值遇到问题"
        link-external
        link="mqqapi://card/show_pslcard?src_type=internal&version=1&uin=939924027&card_type=group&source=qrcode"
      ></f7-list-item>
      <f7-list-item
        title="小纬客服"
        text="Token团队的萌妹子"
        link-external
        link="mqqwpa://im/chat?chat_type=wpa&uin=2577438164&version=1&src_type=web&web_src=web.wutnews.net"
      ></f7-list-item>
...
<script>
import { getStations } from 'electric-service';
...
export default {
  methods: {
    ...
    telephone() {
      const stationButtons = getStations()
